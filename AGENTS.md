...
- Upstream remote: `origin` → https://github.com/Sonarr/Sonarr
- Personal fork remote: `fork` → https://github.com/bwsinger/Sonarr
- Maintained branch: `media-server-dev`, initially based on `v4.0.20.3014`.
